...
import { Layout, Typography, Button, Card, Row, Col, Space, Divider, Avatar, List, Tag, Progress, Statistic, Badge } from 'antd';
import { 
  HomeOutlined, 
  UserOutlined, 
  SolutionOutlined, 
        ...
        <div className="header-content">
          ...
          <Space size="large" className="nav-links">
            {footerLinks.map(link => (
              <Button key={link.title} type="text" className="nav-button" icon={link.icon}>
                {link.title}
              </Button>
            ))}
          </Space>
